...
//import {ArtifactClient, UploadOptions, UploadInfo} from '@actions/artifact' uncomment once package gets published
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (searchResult.filesToUpload.length === 0) {
                ...
                // use artifact package to upload the artifact once it gets published
            }
        }
        catch (err) {
